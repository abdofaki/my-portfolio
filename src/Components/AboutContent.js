    ...
    <>
      <div className="about">
        <div className="left">
          ...
          <p className="aboutMe">
            Full-stack Java developer proficient in utilizing a wide variety of
            programs and tools to create high-quality applications and systems
            to boost organizational efficiency and productivity
          </p>
          {/* <Link to="/Contact">
